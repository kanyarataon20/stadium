...
if (isset($_GET['Del_id'])) {
  $sql = 'DELETE FROM list WHERE memtel ="' . $_GET['Del_id'] . '"';
        ...
        ?>
          <tbody>
            <tr class="table-into">
              ...
              <td><?PHP echo $prm ?></td>
              <td>
                <a href="list.php.?Del_id=<?php echo $data['memtel']; ?>" class="btn btn-danger"><i class="bi bi-person-fill-dash"></i> ยกเลิก</a>
              </td>
            </tr>
          <?php } ?>
      </table>
